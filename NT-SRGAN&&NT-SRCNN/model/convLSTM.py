...
class CLSTM_cell(nn.Module):
    ...
    def forward(self, input, hidden_state):
        ...
        # o=torch.sigmoid(ao)
        # g=torch.tanh(ag)
        i=torch.sigmoid(self.bn(ai))
        f=torch.sigmoid(self.bn(af))
        o=torch.sigmoid(self.bn(ao))
        g=torch.tanh(self.bn(ag))
...
if __name__ == '__main__':
    ...
    hideden_state, out=conv_lstm(input, hidden_state)
    print(input.shape)
    print(out.shape)
    # hideden_state, out=conv_lstm(out, hidden_state)
