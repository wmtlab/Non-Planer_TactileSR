...
TRAIN_NAME = "srcnn_dataset_x5_lay_num_" + str(lay_num)
...
model = SRCNN_MSRN(feature_layers_num=lay_num, scale_factor=scale_factor, is_init=True).cuda()       
is_nor = False  
scale_value = 1000
scale_value_z = 1000
scale_value_xy = 1000
...
# 加载训练数据
dataset_file = root_path + 'dataset/TSR_data_x5/train/'              # 原始数据集
